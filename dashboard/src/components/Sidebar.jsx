export default function Sidebar() {
  ...
  return (
    <aside className="w-60 h-screen bg-white border-r border-neutra-300 flex flex-col justify-between items-center p-6 sticky top-0">
      <div className="flex items-center justify-center w-full px-5 py-4 border border-neutra-300">
        <img
          src="../assets/logo.svg"
          alt="Trashbeta Logo"
